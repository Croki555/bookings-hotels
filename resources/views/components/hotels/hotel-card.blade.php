<div class="bg-white rounded shadow-md flex card text-grey-darkest">
    <img class="w-1/2 h-full rounded-l-sm" src="{{route('index')}}/images/hotels/{{ $hotel->poster_url }}" alt="Hotel Image">
    <div class="w-full flex flex-col justify-between p-4">
        ...
        <div class="pt-2">
            <span class="text-2xl text-grey-darkest">{{ $hotelPrice }}₽/</span>
